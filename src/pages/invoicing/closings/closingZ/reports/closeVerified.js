...
export default class ReportCloseV extends React.PureComponent {
  render() {
    ...
    const diffDataphone = data?.newQuantityDataphone - quantityDataphone;
    ...
    const creditPayments = data?.paymentsCredit?.reduce((sum, payment) => sum + payment?.value, 0);

    const diff = data?.newTotalPaymentReport + data?.newExpense - data?.newTotalPaymentRegister;
    const diffBank = data?.newQuantityBank - ((quantityBank || 0) + quantityCreditBank);

    return (
      <div style={classes.content}>
        <div style={classes.header}>
          <img src="/logo.svg" alt="logo" width="50%" style={{ marginBottom: -15 }} />
          <div style={{ ...classes.title, marginBottom: 5 }}>CIERRE VERIFICADO</div>
          ...
          <div style={classes.body}>
            ...
            <div style={classes.text}>
              <div style={classes.row}>
                ...
                <div style={classes.col2}>
                  {numeral(
                    totalPayments + totalCreditPayments + data?.newTotalPaymentRegister,
                  ).format('$ 0,0')}
                </div>
              </div>
            </div>
            ...
            <div style={classes.text}>
              <div style={classes.row}>
                <div style={classes.col1}>Valor:</div>
                <div style={classes.col2}>{numeral(data?.refunds?.value || 0).format('$ 0,0')}</div>
              </div>
            </div>
            <div style={classes.text}>
              <div style={classes.row}>
            ...
            <div style={classes.text}>
              <div style={classes.row}>
                ...
                <div style={classes.col2}>
                  {numeral(data?.newTotalPaymentRegister).format('$ 0,0')}
                </div>
              </div>
            </div>
            <div style={classes.text}>
              <div style={classes.row}>
                ...
                <div style={classes.col2}>
                  {numeral(data?.newTotalPaymentReport).format('$ 0,0')}
                </div>
              </div>
            </div>
            <div style={classes.text}>
              <div style={classes.row}>
                ...
                <div style={classes.col2}>{numeral(data?.newExpense).format('$ 0,0')}</div>
              </div>
            </div>
            {diff !== 0 && (
              <div style={classes.text}>
            ...
            <>
              ...
              <div style={classes.text}>
                <div style={classes.row}>
                  ...
                  <div style={classes.col2}>{data?.newQuantityDataphone || 0}</div>
                </div>
              </div>
              {diffDataphone !== 0 && (
                <div style={classes.text}>
            ...
            <div style={classes.text}>
              <div style={classes.row}>
                ...
                <div style={classes.col2}>{data?.newQuantityBank}</div>
              </div>
            </div>
            {diffBank !== 0 && (
              <div style={classes.text}>
            ...
            <div style={classes.text}>
              <div style={classes.row}>
                ...
                <div style={classes.col2}> {numeral(creditPayments).format('$ 0,0')}</div>
              </div>
            </div>
          </div>
        </div>
