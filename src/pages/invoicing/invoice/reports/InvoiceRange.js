...
export default class InvoiceRangeReport extends React.PureComponent {
  render() {
        ...
        {dataArray?.map((data, index) => {
          ...
          return (
            <div key={index}>
              <div style={classes.container}>
                ...
                <div style={classes.body}>
                  <div style={classes.headersTable}>
                    ...
                    <div style={{ ...classes.textBold, textAlign: 'center', width: '11%' }}>
                      CANT
                    </div>
                    <div style={{ ...classes.textBold, width: '25%', textAlign: 'end' }}>
                      PRECIO
                    </div>
                  ...
                  {data?.details?.map(({ product, quantity, price }) => (
                    <div style={classes.lineItems} key={product?.barcode}>
                      ...
                      <div style={{ ...classes.text, textAlign: 'center', width: '11%' }}>
                        {quantity}
                      </div>
                ...
                <div style={classes.footerTable}>
                  ...
                  <div style={{ ...classes.textBold, width: '11%', textAlign: 'center' }}>
                    {totalItems}
                  </div>
                </div>
                <div style={classes.footerTable}>
                ...
                <div style={classes.taxes}>
                  <div style={{ ...classes.textBold, textAlign: 'center' }}>
                  ...
                  <div style={classes.footerTaxesContainer}>
                    <div style={{ ...classes.footerTaxes, width: '50%' }}>
                      ...
                      <div style={classes.text}>
                        {numeral(data?.summary?.subtotal).format('0,0.00')}
                      </div>
                    </div>
                  ...
                  <div style={classes.text}>
                    ...
                    {data?.payments?.reduce(
                      (text, { payment }) => `${text} ${payment?.name},`,
                      ' ',
                    )}
                  </div>
                </div>
                ...
                <div style={classes.footer}>
                  ...
                  <div style={classes.items}>
                    ...
                    <div style={classes.text}>
                      ● No deben estar sucias, rotas, desgastadas o manchadas.
                    </div>
                    <div style={classes.text}>
              ...
              {index + 1 === dataArray?.length && <div className={classes.pageBreak} />}
            </div>
          );
        })}
      </div>
