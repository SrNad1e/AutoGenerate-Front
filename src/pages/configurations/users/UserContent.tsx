...
const UsersList = ({ propsWeb }: content) => {
  ...
  const onFinish = (value: FormValues, pageCurrent?: number) => {
    ...
    onSearch({ ...params, ...filters, isWeb: propsWeb });
  ...
  const handleChangeTable = (
    ...
    onSearch({ ...prop, sort, page: current, ...filters, isWeb: propsWeb });
      ...
      <Card>
        <Form form={form} onFinish={onFinish}>
          <Row gutter={[20, 20]} align="middle">
            <Col xs={24} md={5} lg={propsWeb === true ? 12 : 7} xl={propsWeb === true ? 12 : 7}>
